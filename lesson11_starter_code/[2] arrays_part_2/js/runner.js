...
check(1, q1 && q1.length == 3 && (q1[0] == 'image1.jpeg' || q1[0] == 'images/image1.jpeg') && (q1[1] == 'image2.jpeg' || q1[1] == 'images/image2.jpeg') && (q1[2] == 'image3.jpeg' || q1[2] == 'images/image3.jpeg'));
check(2, q2 && (q2 == 'image1.jpeg' || q2 == 'images/image1.jpeg'));
check(3, q3 && q3 == 3);
check(4, q3 && (q4 == 'image3.jpeg' || q4 == 'images/image3.jpeg'));
