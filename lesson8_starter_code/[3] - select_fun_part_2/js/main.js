...
// 11.	Select any spans that are siblings of an h4 (using the .siblings() method) and hide them.h4
...
// I think you meant to hide all the h2s but if you meant just in #box7, I would change selector to $('#box7 h2')
